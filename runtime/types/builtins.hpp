...
vec3 min(vec3 x, float y) {
  return make_vec3(std::min(x[0], y), std::min(x[1], y),
                   std::min(x[2], y));
};
vec4 min(vec4 x, float y) {
  return make_vec4(std::min(x[0], y), std::min(x[1], y),
                   std::min(x[2], y), std::min(x[3], y));
};
...
ivec3 min(ivec3 x, int32_t y) {
  return make_ivec3(std::min(x[0], y), std::min(x[1], y),
                   std::min(x[2], y));
};
ivec4 min(ivec4 x, int32_t y) {
  return make_ivec4(std::min(x[0], y), std::min(x[1], y),
                   std::min(x[2], y), std::min(x[3], y));
};
...
uvec3 min(uvec3 x, uint32_t y) {
  return make_uvec3(std::min(x[0], y), std::min(x[1], y),
                   std::min(x[2], y));
};
uvec4 min(uvec4 x, uint32_t y) {
  return make_uvec4(std::min(x[0], y), std::min(x[1], y),
                   std::min(x[2], y), std::min(x[3], y));
};
...
vec3 max(vec3 x, float y) {
  return make_vec3(std::max(x[0], y), std::max(x[1], y),
                   std::max(x[2], y));
};
vec4 max(vec4 x, float y) {
  return make_vec4(std::max(x[0], y), std::max(x[1], y),
                   std::max(x[2], y), std::max(x[3], y));
};
...
ivec3 max(ivec3 x, int32_t y) {
  return make_ivec3(std::max(x[0], y), std::max(x[1], y),
                   std::max(x[2], y));
};
ivec4 max(ivec4 x, int32_t y) {
  return make_ivec4(std::max(x[0], y), std::max(x[1], y),
                   std::max(x[2], y), std::max(x[3], y));
};
...
uvec3 max(uvec3 x, uint32_t y) {
  return make_uvec3(std::max(x[0], y), std::max(x[1], y),
                   std::max(x[2], y));
};
uvec4 max(uvec4 x, uint32_t y) {
  return make_uvec4(std::max(x[0], y), std::max(x[1], y),
                   std::max(x[2], y), std::max(x[3], y));
};
