...
(cd build && clang++ lib.cpp -shared -o ./shader.so -fPIC -Ofast -Wall -Wextra -std=c++14 -fno-exceptions -ffast-math -Wno-unused-function -fno-math-errno  -lm) # TODO: enable the parameter again
