...
clang++ build/lib.cpp -shared -o build/shader.so -Ofast -Wall -Wextra -std=c++14 -fno-exceptions -ffast-math -Wno-unused-function -fno-math-errno # TODO: enable the parameter again
