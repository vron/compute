...
(cd build && clang++ lib.cpp -shared -o ./shader.so -fPIC -Ofast -Wall -Wextra -std=c++2a -ffast-math -Wno-unused-function -fno-math-errno -Werror -lm) # TODO: enable the parameter again
