...
(cd build && clang++ lib.cpp routines/arch/*.S -shared -o ./shader.so -fPIC -Ofast -Wall -Wextra -std=c++2a -fvisibility=hidden -ffast-math -Wno-unused-function -fno-math-errno -Werror -lm) # TODO: enable the parameter again
